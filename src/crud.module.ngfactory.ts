...
import * as import20 from './input.component.ngfactory';
...
class CrudModuleInjector extends import0.NgModuleInjector<import1.CrudModule> {
  ...
  _CrudModule_4:import1.CrudModule;
  __LOCALE_ID_5:any;
  ...
  constructor(parent:import19.Injector) {
    super(parent,[import20.InputTextComponentNgFactory],([] as any[]));
  }
  get _LOCALE_ID_5():any {
    if ((this.__LOCALE_ID_5 == null)) { (this.__LOCALE_ID_5 = import3._localeFactory(this.parent.get(import21.LOCALE_ID,(null as any)))); }
  ...
  get _APP_ID_13():any {
    if ((this.__APP_ID_13 == null)) { (this.__APP_ID_13 = import22._appIdRandomProviderFactory()); }
  ...
  get _EventManager_17():import12.EventManager {
    if ((this.__EventManager_17 == null)) { (this.__EventManager_17 = new import12.EventManager(this._EVENT_MANAGER_PLUGINS_16,this.parent.get(import25.NgZone))); }
  ...
  get _RootRenderer_21():any {
    if ((this.__RootRenderer_21 == null)) { (this.__RootRenderer_21 = import26._createConditionalRootRenderer(this._DomRootRenderer_20,this.parent.get(import26.NgProbeToken,(null as any)),this.parent.get(import9.NgProbeToken,(null as any)))); }
  ...
  get _AnimationQueue_24():import16.AnimationQueue {
    if ((this.__AnimationQueue_24 == null)) { (this.__AnimationQueue_24 = new import16.AnimationQueue(this.parent.get(import25.NgZone))); }
  ...
  createInternal():import1.CrudModule {
    ...
    this._CrudModule_4 = new import1.CrudModule();
    ...
    this._ApplicationRef__10 = new import9.ApplicationRef_(this.parent.get(import25.NgZone),this.parent.get(import27.Console),this,this._ErrorHandler_7,this,this._ApplicationInitStatus_8,this.parent.get(import8.TestabilityRegistry,(null as any)),this._Testability_9);
    return this._CrudModule_4;
  }
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import1.CrudModule)) { return this._CrudModule_4; }
    if ((token === import21.LOCALE_ID)) { return this._LOCALE_ID_5; }
    if ((token === import6.NgLocalization)) { return this._NgLocalization_6; }
    if ((token === import28.ErrorHandler)) { return this._ErrorHandler_7; }
    ...
    if ((token === import29.DOCUMENT)) { return this._DOCUMENT_14; }
    ...
    if ((token === import30.AnimationDriver)) { return this._AnimationDriver_19; }
    if ((token === import14.DomRootRenderer)) { return this._DomRootRenderer_20; }
    if ((token === import31.RootRenderer)) { return this._RootRenderer_21; }
    if ((token === import15.DomSanitizer)) { return this._DomSanitizer_22; }
    if ((token === import32.Sanitizer)) { return this._Sanitizer_23; }
