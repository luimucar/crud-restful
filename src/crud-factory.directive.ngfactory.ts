...
import * as import0 from './crud-factory.directive';
import * as import1 from '@angular/core/src/change_detection/change_detection_util';
import * as import2 from '@angular/core/src/linker/view';
import * as import3 from '@angular/core/src/linker/view_utils';
export class Wrapper_CrudFactoryDirective {
  /*private*/ _eventHandler:Function;
  context:import0.CrudFactoryDirective;
  ...
  constructor(p0:any,p1:any) {
    this._changed = false;
    this._changes = {};
    this.context = new import0.CrudFactoryDirective(p0,p1);
  ...
  check_index(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_1,currValue))) {
      ...
      this._changes['index'] = new import1.SimpleChange(this._expr_1,currValue);
  ...
  check_clazzName(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_2,currValue))) {
      ...
      this._changes['clazzName'] = new import1.SimpleChange(this._expr_2,currValue);
  ...
  check_model(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_3,currValue))) {
      ...
      this._changes['model'] = new import1.SimpleChange(this._expr_3,currValue);
