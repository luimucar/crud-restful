...
import * as import18 from 'ng2-translate/src/translate.pipe';
...
import * as import22 from 'ng2-translate/src/translate.service';
import * as import23 from '@angular/common/src/directives/ng_for';
import * as import24 from 'primeng/components/button/button';
export class Wrapper_CrudComponent {
  ...
  check_translate(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_2,currValue))) {
      this._changed = true;
      this.context.translate = currValue;
...
export class View_CrudComponent0 extends import2.AppView<import0.CrudComponent> {
  ...
  createInternal(rootSelector:string):import9.ComponentRef<any> {
    ...
    this._NgFor_0_6 = new import15.Wrapper_NgFor(this._vc_0.vcRef,this._TemplateRef_0_5,this.parentView.injectorGet(import20.IterableDiffers,this.parentIndex),this.ref);
    ...
    this._el_6 = import3.createRenderElement(this.renderer,this._el_4,'button',new import3.InlineArray4(4,'pButton','','type','button'),(null as any));
    this._DomHandler_6_3 = new import16.DomHandler();
    this._Button_6_4 = new import17.Wrapper_Button(new import21.ElementRef(this._el_6),this._DomHandler_6_3);
    ...
    this._Button_8_4 = new import17.Wrapper_Button(new import21.ElementRef(this._el_8),this._DomHandler_8_3);
    ...
    this._pipe_translate_0 = new import18.TranslatePipe(this.parentView.injectorGet(import22.TranslateService,this.parentIndex),this.ref);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import24.Button) && (6 === requestNodeIndex))) { return this._Button_6_4.context; }
    if (((token === import16.DomHandler) && (8 === requestNodeIndex))) { return this._DomHandler_8_3; }
    if (((token === import24.Button) && (8 === requestNodeIndex))) { return this._Button_8_4.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    valUnwrapper.reset();
    const currVal_6_0_0:any = import3.inlineInterpolate(1,'',valUnwrapper.unwrap(this._pipe_translate_0.transform('COMMON.BUTTON.SAVE')),'');
    this._Button_6_4.check_label(currVal_6_0_0,throwOnChange,valUnwrapper.hasWrappedValue);
