...
export class View_ChipsComponent0 extends import2.AppView<import0.ChipsComponent> {
  ...
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    ...
    this._el_3 = import3.createRenderElement(this.renderer,this._el_1,'div',new import3.InlineArray2(2,'class','col-md-4'),(null as any));
    ...
    this._el_9 = import3.createRenderElement(this.renderer,this._el_1,'div',new import3.InlineArray2(2,'class','col-md-8'),(null as any));
