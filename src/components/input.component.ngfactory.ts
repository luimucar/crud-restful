...
export class View_InputTextComponent0 extends import2.AppView<import0.InputTextComponent> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_17:any = import3.inlineInterpolate(1,'',this.context.id,'');
    if (import3.checkBinding(throwOnChange,this._expr_17,currVal_17)) {
      this.renderer.setElementProperty(this._el_11,'id',currVal_17);
      this._expr_17 = currVal_17;
    }
    const currVal_18:any = import3.inlineInterpolate(1,'',this.context.inputType,'');
    if (import3.checkBinding(throwOnChange,this._expr_18,currVal_18)) {
      this.renderer.setElementProperty(this._el_11,'type',currVal_18);
      this._expr_18 = currVal_18;
    }
    const currVal_19:any = import3.inlineInterpolate(1,'',this.context.name,'');
    if (import3.checkBinding(throwOnChange,this._expr_19,currVal_19)) {
      this.renderer.setElementProperty(this._el_11,'name',currVal_19);
      this._expr_19 = currVal_19;
    }
    const currVal_20:any = this.context.value;
    if (import3.checkBinding(throwOnChange,this._expr_20,currVal_20)) {
      this.renderer.setElementProperty(this._el_11,'value',currVal_20);
      this._expr_20 = currVal_20;
    }
    const currVal_21:any = this.context.readonly;
    if (import3.checkBinding(throwOnChange,this._expr_21,currVal_21)) {
      this.renderer.setElementProperty(this._el_11,'readOnly',currVal_21);
      this._expr_21 = currVal_21;
    }
    const currVal_22:any = this.context.disabled;
    if (import3.checkBinding(throwOnChange,this._expr_22,currVal_22)) {
      this.renderer.setElementProperty(this._el_11,'disabled',currVal_22);
