        ...
        this.components.forEach(function (component) {
            ...
            if (component.regexp) {
                ...
                if (component.value instanceof Array && component.value != undefined && component.value.length > 0) {
                    component.value.forEach(function (value) {
                        if (!_this.validateRegexp(regexp, component.name, value, component.property, component.clazzName, component.translateKey, component.regexpMessageKey, component.regexpMessage)) {
                            ret = false;
                            return;
                        }
                    });
                ...
                if (!(component.value instanceof Array) && component.value != undefined && component.value != '') {
                    ret = _this.validateRegexp(regexp, component.name, component.value, component.property, component.clazzName, component.translateKey, component.regexpMessageKey, component.regexpMessage);
                }
            }
        });
        return ret;
    };
    CrudComponent.prototype.validateRegexp = function (regexp, name, value, property, clazzName, translateKey, regexpMessageKey, regexpMessage) {
