...
CrudModule = __decorate([
    core_1.NgModule({
        declarations: [crud_component_1.CrudComponent, crud_factory_directive_1.CrudFactoryDirective, input_component_1.InputTextComponent, multiselect_component_1.MultiSelectComponent, chips_component_1.ChipsComponent, select_component_1.SelectComponent, calendar_component_1.CalendarComponent],
        ...
        entryComponents: [input_component_1.InputTextComponent, multiselect_component_1.MultiSelectComponent, chips_component_1.ChipsComponent, select_component_1.SelectComponent, calendar_component_1.CalendarComponent]
    })
], CrudModule);
