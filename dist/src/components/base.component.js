...
var BaseComponent = (function (_super) {
    ...
    BaseComponent.showOrHideComponets = function (clazzName, display) {
        ...
        */
        var counter = 0;
        $("#buttons" + clazzName).animate({ 'width': 'toggle' }, { 'duration': 500 });
        index_1.CrudComponentObj.getComponents(clazzName).forEach(function (c) {
            $("#calendar" + clazzName + counter).animate({ 'width': 'toggle' }, { 'duration': 500 });
            $("#checkboxes" + clazzName + counter).animate({ 'width': 'toggle' }, { 'duration': 500 });
            $("#chips" + clazzName + counter).animate({ 'width': 'toggle' }, { 'duration': 500 });
            $("#input" + clazzName + counter).animate({ 'width': 'toggle' }, { 'duration': 500 });
            $("#multiselect" + clazzName + counter).animate({ 'width': 'toggle' }, { 'duration': 500 });
            $("#select" + clazzName + counter).animate({ 'width': 'toggle' }, { 'duration': 500 });
            $("#radioboxes" + clazzName + counter).animate({ 'width': 'toggle' }, { 'duration': 500 });
            counter++;
        });
    };
